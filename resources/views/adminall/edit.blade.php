...
<form method="POST" action="{{ route('adminall.update', ['id_event' => $event->id_event]) }}">
    ...
    <div class="form-group">
        ...
        <input type="checkbox" name="active" value="1" {{ $event->active ? 'checked' : '' }} checked>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="checkbox" name="sembunyikan_foto" value="1" {{ $event->sembunyikan_foto ? 'checked' : '' }} checked>
    </div>
